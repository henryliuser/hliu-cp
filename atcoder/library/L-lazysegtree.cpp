...
// figure out how to merge inversion segments
#include <bits/stdc++.h>
...
// lazy seg definition
using S = array<ll, 3>;  // {0's, 1's, inv's}
using F = bool;
S op(S l, S r) {
    ll z = l[0] + r[0];
    ll o = l[1] + r[1];
    ll n = l[1] * r[0];
    return {z, o, n+l[2]+r[2]};
}
S e() { return S{ 0, 0, 0 }; }
S mapping(F l, S r) {
    if (!l) return r;
    // find the number of pairs of opposites,
    // then subtract original inversions
    return { r[1], r[0], r[0]*r[1] - r[2] };
}
